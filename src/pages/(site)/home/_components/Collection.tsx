  ...
  return (
    <div className='my-[74px] relative'>
      <video autoPlay loop muted className='w-full h-auto sm:hidden block'>
        <source
          src='https://cb2.scene7.com/is/content/CB2/video/103124_HolidayHub_ChristmasDecor_M.mp4'
          type='video/mp4'
        />
      </video>
      <video autoPlay loop muted className='w-full h-auto sm:block hidden'>
        <source
          src='https://cb2.scene7.com/is/content/CB2/video/103124_HolidayHub_ChristmasDecor_D.mp4'
          type='video/mp4'
        />
      </video>
