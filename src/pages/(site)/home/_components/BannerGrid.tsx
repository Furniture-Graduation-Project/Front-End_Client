      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 lg:grid-flow-col gap-7 *:bg-neutral-2 '>
        <div className='row-span-3 h-auto sm:h-[784px] relative rounded-xl'>
          <div className='absolute top-[48px] left-[48px] space-y-2'>
            ...
            <Link
              className='underline flex items-center button-s transition duration-500 ease-in-out transform hover:translate-x-2 hover:opacity-70 hover:scale-105'
              to={'/products?category=67572352995835d9927b4924'}
            >
              {t('shopNow', 'Shop now')} <ArrowRight className='h-4' />
            </Link>
          </div>
          <Link to={'/products?category=67572352995835d9927b4924'}>
            <img
        ...
        <div className='h-auto sm:h-[378px] relative rounded-xl'>
          <div className='absolute sm:bottom-[48px] max-[640px]:top-[48px] left-[48px]  space-y-2'>
            ...
            <Link
              className='underline flex items-center button-s transition duration-500 ease-in-out transform hover:translate-x-2 hover:opacity-70 hover:scale-105'
              to={'/products?category=6757235d995835d9927b492b'}
            >
              {t('shopNow', 'Shop now')} <ArrowRight className='h-4' />
            </Link>
          </div>
          <Link to={'/products?category=6757235d995835d9927b492b'}>
            <img
              src={BannerGrid1}
        ...
        <div className='h-auto sm:h-[378px] relative rounded-xl'>
          <div className='absolute sm:bottom-[48px] max-[640px]:top-[48px] left-[48px]  space-y-2'>
            ...
            <Link
              className='underline flex items-center button-s transition duration-500 ease-in-out transform hover:translate-x-2 hover:opacity-70 hover:scale-105'
              to={'/products?category=6757236b995835d9927b4932'}
            >
              {t('shopNow', 'Shop now')} <ArrowRight className='h-4' />
            </Link>
          </div>
          <Link to={'/products?category=6757236b995835d9927b4932'}>
            <img
              src={BannerGrid2}
