  ...
  return (
    <div>
      <div className='lg:sticky lg:top-28'>
        <div className=''>
          <h1 className='text-xl font-medium'>Have a coupon</h1>
          ...
          <form action='' className='mt-4'>
            <div className='flex py-2 px-6  border border-[#6C7275] justify-between rounded-sm w-full'>
              <div className='flex'>
                ...
                <input type='text' className='focus:outline-none w-24 sm:w-auto' placeholder='Coupon Code' />
              </div>
        ...
        <div className='p-6 border rounded-md border-black mt-4'>
          <h1 className='mb-4 text-xl font-medium'>Cart Summary</h1>
          <Form {...form}>
                      ...
                      <RadioGroup onValueChange={field.onChange} defaultValue={field.value} className='flex flex-col'>
                        ...
                        >
                          <div className='flex items-center space-x-3 space-y-0'>
                            ...
                            <FormLabel className='font-normal cursor-pointer'>Free Shipping</FormLabel>
                          </div>
                        ...
                        >
                          <div className='flex items-center space-x-3 space-y-0'>
                            ...
                            <FormLabel className='font-normal cursor-pointer'>Express Shipping</FormLabel>
                          </div>
                          <p className='text-right'>$0.00</p>
                        </FormItem>
                        <FormItem
                        ...
                        >
                          <div className='flex items-center space-x-3 space-y-0'>
                            ...
                            <FormLabel className='font-normal cursor-pointer'>Pick Up</FormLabel>
                          </div>
                          <p className='text-right'>$0.00</p>
                        </FormItem>
                      </RadioGroup>
