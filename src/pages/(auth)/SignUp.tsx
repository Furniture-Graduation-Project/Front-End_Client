...
const SignUp = () => {
  ...
  return (
    <div className='py-4 px-6 sm:px-12 lg:px-24 xl:px-32 sm:h-full flex flex-col justify-center text-neutral-4 space-y-6'>
      <h1 className='headline-7 sm:headline-6 lg:headline-5 xl:headline-4  text-black'>Sign Up</h1>
        ...
        <div className='mb-6'>
          <div className='flex leading-none lg:mb-0 space-x-2'>
            ...
            <label htmlFor='remember' className='caption-2 sm:body-2'>
              I agree with <span className='text-black caption-2-semi sm:body-2-semi'>Privacy Policy</span> and Terms of
              Use <span className='text-black caption-2-semi sm:body-2-semi'>Terms of Use</span>
            </label>
          </div>
        </div>
